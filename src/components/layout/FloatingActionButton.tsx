      ...
      <AnimatePresence>
        {isExpanded && (
          <>
            ...
            >
              <span className="bg-[#1A1A1A] text-white text-xs font-medium px-3 py-1.5 rounded-lg shadow-md whitespace-nowrap">
                WhatsApp
              </span>
            ...
            >
              ...
              <div className="w-12 h-12 rounded-full bg-[#E60000] flex items-center justify-center shadow-lg">
