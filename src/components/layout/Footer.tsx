        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-display text-xl font-bold">SP Granites</h3>
                <p className="text-xs text-gray-400">Premium Stone Works</p>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Crafting premium granite and marble solutions for over 25 years. 
              Your trusted partner for quality stone products and expert installation.
            </p>
