...
const categories: Category[] = [
  {
    ...
    bgColor: 'bg-gradient-to-br from-rose-50 via-red-50 to-pink-100',
  ...
  },
  {
    ...
    bgColor: 'bg-gradient-to-br from-slate-50 via-indigo-50 to-blue-100',
  ...
  },
  {
    ...
    bgColor: 'bg-gradient-to-br from-teal-50 via-cyan-50 to-emerald-100',
  ...
  },
  {
    ...
    bgColor: 'bg-gradient-to-br from-stone-50 via-neutral-50 to-gray-100',
  ...
  },
  {
    ...
    bgColor: 'bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-100',
